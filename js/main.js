  ...
  if (certsContainer && portfolioData.certifications) {
    certsContainer.innerHTML = portfolioData.certifications.map(c => `
      <div class="cert-card">
        ...
        <p class="cert-issuer">${c.issuer} &bull; <span class="text-muted">${c.date}</span></p>
...
Available Commands:
  ...
  <span class="t-output-highlight">uname -a</span>      - Kernel & OS environment (RHEL 8/9, CentOS, SUSE)
  <span class="t-output-highlight">skills</span>        - Technical skills matrix (LVM, Ansible, Bash, vSphere)
  <span class="t-output-highlight">experience</span>    - Tata Consultancy Services (TCS) enterprise background
  <span class="t-output-highlight">projects</span>      - OS fleet migrations, storage upgrades & Ansible automation
  <span class="t-output-highlight">certs</span>         - RHCSA (EX200), Azure (AZ-900), and Azure (AZ-104)
  <span class="t-output-highlight">education</span>     - University & academic qualifications
...
<span class="t-output-cyan">Company:</span> ${portfolioData.personal.status}
<span class="t-output-cyan">Location:</span> ${portfolioData.personal.location}
<span class="t-output-cyan">Experience:</span> 2+ Years in Production Support & Systems Administration
`,
    'uptime': () => `
16:45:12 up 784 days, 12:20, 1 active admin, load average: 0.05, 0.03, 0.01
[OK] Production Environment SLA Uptime: <span class="t-output-highlight">99.9% High Availability</span>
`,
    'uname -a': () => `
Linux rhel-prod-node01 5.14.0-362.8.1.el9_3.x86_64 #1 SMP PREEMPT_DYNAMIC GNU/Linux (RHEL 8/9 / CentOS / SUSE)
`,
    'skills': () => `
<table class="t-table">
  <tr><th>Category</th><th>Technologies & Tools</th></tr>
  <tr><td>Operating Systems</td><td>RHEL 8/9, CentOS, SUSE Linux, Ubuntu Server, IBM AIX (monitoring), Windows Server</td></tr>
  <tr><td>Automation & Scripting</td><td>Bash Shell Scripting, Ansible Playbooks, Cron Jobs, Patch Management</td></tr>
  <tr><td>Storage & Virtualization</td><td>LVM Storage Architecture, VMware vSphere VM Lifecycle, Dell EMC NetWorker, Data Domain OS</td></tr>
  <tr><td>Troubleshooting & Security</td><td>L2/L3 RCA (top, iostat, vmstat, netstat, dmesg), syslog, who/last, ServiceNow ITSM</td></tr>
</table>
`,
    'experience': () => `
...
- Managed & maintained scalable RHEL, CentOS & SUSE Linux environments (99.9% uptime).
- Orchestrated automated patching cycles & vulnerability remediation via Ansible Playbooks.
- Optimized disk provisioning via LVM (vgextend, lvextend), partition tables & swap layouts with zero downtime.
- Administered VM lifecycle (commissioning/decommissioning) in VMware vSphere.
- Created robust Bash scripts for DB log compression, directory cleanups & system alerts.
- Led L2/L3 troubleshooting for critical service bottlenecks (iostat, vmstat, netstat, dmesg).
- Audited syslog & monitored security logs (who, last) for access compliance.
- Supervised backups & restores via Dell EMC NetWorker CLI (99%+ success rate).
- Supported IBM AIX legacy systems & executed offline backups.
- Handled L2/L3 incidents, change requests & problem management under ITIL in ServiceNow.
- Created Ansible verification playbooks for automated pre/post-release health checks.
- Maintained comprehensive SOPs, runbooks & Confluence documentation.
- Handled DR recovery drills & automated L2 agent patching with Ansible & Bash.
`,
    'projects': () => `
...
`,
    'neofetch': () => `
<span class="t-output-highlight">       .---.       </span><span class="t-output-cyan">pranjal@tcs-infrastructure</span>
<span class="t-output-highlight">      /     \\      </span>-------------------------
<span class="t-output-highlight">     | () () |     </span><span class="t-output-cyan">OS:</span> Red Hat Enterprise Linux 8/9, CentOS, SUSE
<span class="t-output-highlight">      \\  _  /      </span><span class="t-output-cyan">Host:</span> VMware vSphere Virtual Platform
<span class="t-output-highlight">       /___\\       </span><span class="t-output-cyan">Uptime:</span> 99.9% SLA High Availability
<span class="t-output-highlight">      /     \\      </span><span class="t-output-cyan">Shell:</span> bash 5.1 / Ansible Automation
<span class="t-output-highlight">     / |   | \\     </span><span class="t-output-cyan">Role:</span> Linux System Administrator
